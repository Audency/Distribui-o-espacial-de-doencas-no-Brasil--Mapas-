...
um <- tm_shape(dados_mapa) +
  ...
  # Exportando o mapa como TIFF com 300 dpi
  tmap_save(um, filename = "um.tiff", dpi = 300)
...
##################### Mapa para   faixa etaria 3 a 4anos ######################################
  ...
  # Exportando o mapa como TIFF com 300 dpi
  tmap_save(dois , filename = "dois.tiff", dpi = 300)
...
tres <- tm_shape(dados_mapa) +
  ...
  # Exportando o mapa como TIFF com 300 dpi
  tmap_save(tres , filename = "tres.tiff", dpi = 300)
...
quatro <- tm_shape(dados_mapa) +
  ...
  # Exportando o mapa como TIFF com 300 dpi
  tmap_save(quatro , filename = "quatro.tiff", dpi = 300)
...
##################### Mapa para   faixa etaria 18 a 39 anos ######################################
  ...
  # Exportando o mapa como TIFF com 300 dpi
  tmap_save(cinco , filename = "cinco.tiff", dpi = 300)
...
##################### Mapa para   faixa etaria  >= 40 anos ######################################
  ...
  # Exportando o mapa como TIFF com 300 dpi
  tmap_save( seis, filename = " seis.tiff", dpi = 300)
